function srcTable(nRow) {
  debugger;
    var tableInfo = ReactAPI.getComponentAPI("SupDataGrid").APIs("material_1.0.0_businessDetail_businessnewDAtaList_businessDetail_sdg").getValueByKey(nRow, "billCode");
    var id = ReactAPI.getComponentAPI("SupDataGrid").APIs("material_1.0.0_businessDetail_businessnewDAtaList_businessDetail_sdg").getValueByKey(nRow, "tableHeadID");
    var tableInfoId = ReactAPI.getComponentAPI("SupDataGrid").APIs("material_1.0.0_businessDetail_businessnewDAtaList_businessDetail_sdg").getValueByKey(nRow, "billInfoId"); //billInfoId
    var operateCode;
    var pcMap;
    var pc;
    // 销售出库
