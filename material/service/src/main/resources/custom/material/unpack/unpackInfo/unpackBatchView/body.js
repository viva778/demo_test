...
function dataInit() {
    ...
    dgDetail = ReactAPI.getComponentAPI().SupDataGrid.APIs("material_1.0.0_unpack_unpackBatchViewdg1668149269775");
    dataInit = () => { };
}
                            ...
                            if (result.code == 200) {
                                ...
                                setTimeout(() => {
                                    ...
                                    dgDetail.refreshDataByRequst({
                                        type: "POST",
                                        url: "/msService/material/unpack/unpackInfo/data-dg1668149269775?datagridCode=material_1.0.0_unpack_unpackBatchViewdg1668149269775&id=" + ReactAPI.getFormData().id
                                    });
                                }, 1000);
                            } else {
                                event.ReactAPI.closeLoading();
