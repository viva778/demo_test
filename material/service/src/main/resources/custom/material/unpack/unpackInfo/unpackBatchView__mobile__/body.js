...
var dgDetailName = "material_1.0.0_unpack_unpackBatchView__mobile__dg1675391381074";

function dataInit() {
    rfStock = ReactAPI.getComponentAPI("Reference").APIs("unpackInfo.stock.availiQuantity");
    dgDetail = ReactAPI.getComponentAPI("Datagrid").APIs("material_1.0.0_unpack_unpackBatchView__mobile__dg1675391381074");
    dataInit = () => {
    };
}
                                ...
                                if (result.code == 200) {
                                    ...
                                    setTimeout(() => {
                                        ...
                                        dgDetail.refreshDataByRequst({
                                            type: "POST",
                                            url: "/msService/material/unpack/unpackInfo/data-dg1675391381074?datagridCode=material_1.0.0_unpack_unpackBatchView__mobile__dg1675391381074&id=" + ReactAPI.getFormData().id
                                        });
                                    }, 1000);
                                } else {
                                    event.ReactAPI.closeLoading();
